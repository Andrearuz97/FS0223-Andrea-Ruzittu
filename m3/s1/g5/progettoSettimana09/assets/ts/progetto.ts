interface Smartphone {
  ...
  class FirstUser implements Smartphone { //utente Vodafone
    carica: number;
    numeroChiamate: number;
    ...
    numero404(): number { //quì vengono restituite il numero di chiamate effettuate
  ...
  class SecondUser implements Smartphone { //utente Tim
    carica: number;
    numeroChiamate: number;
  ...
  class ThirdUser implements Smartphone { //utente Vodafone 
    carica: number;
    numeroChiamate: number;
