...
class ThirdUser {
    ...
    chiamata(minutiDurata) {
        ...
        if (costoChiamata <= this.carica) {
            ...
            console.log("Gentile cliente Wind, il suo saldo è insufficiente per effettuare la chiamata.");
        }
    }
    numero404() {
        return this.carica;
...
console.log("Gentile cliente Tim, il suo saldo disponibile è di euro:", utenteTim.numero404());
...
console.log("Gentile cliente Wind, il suo saldo disponibile è di euro:", utenteWind.numero404());
